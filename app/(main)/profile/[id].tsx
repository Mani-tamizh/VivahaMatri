...
const getMockProfile = (id: string) => {
  return {
    ...
    isPremiumUser: true,
    contactUnlocked: id === '2' // Hack to show both states
  };
};
...
export default function ProfileDetails() {
  ...
  const profile = getMockProfile(id as string);
  const [contactUnlocked, setContactUnlocked] = useState(
        ...
        <View style={styles.topProfileBlock}>
          ...
          <View style={styles.profileDetailsRight}>
            ...
            <View style={styles.infoRow}>
              ...
              <Text style={styles.infoText}>{profile.height} • {profile.religion} - {profile.caste}</Text>
            </View>
          ...
          <View style={styles.gridContainer}>
            ...
            <View style={styles.gridItem}>
              ...
              <View style={styles.gridTextContainer}>
                ...
                <Text style={styles.gridValue}>{profile.dob}</Text>
              </View>
            </View>
            <View style={styles.gridItem}>
              <View style={styles.gridIconCircle}>
            ...
            <View style={styles.gridItem}>
              ...
              <View style={styles.gridTextContainer}>
                ...
                <Text style={styles.gridValue}>{profile.company}</Text>
              </View>
            </View>
            <View style={styles.gridItem}>
              <View style={styles.gridIconCircle}>
          ...
          <View style={styles.gridContainer}>
            <View style={styles.gridItem}>
              ...
              <View style={styles.gridTextContainer}>
                ...
                <Text style={styles.gridValue}>{profile.partnerPref.age}</Text>
              </View>
            </View>
            <View style={styles.gridItem}>
              <View style={styles.gridIconCircle}>
              ...
              <View style={styles.gridTextContainer}>
                ...
                <Text style={styles.gridValue}>{profile.partnerPref.height}</Text>
              </View>
            </View>
            <View style={styles.gridItem}>
              <View style={styles.gridIconCircle}>
              ...
              <View style={styles.gridTextContainer}>
                <Text style={styles.gridLabel}>Education</Text>
                <Text style={styles.gridValue}>{profile.partnerPref.education}</Text>
              </View>
            </View>
            <View style={styles.gridItem}>
              <View style={styles.gridIconCircle}>
              ...
              <View style={styles.gridTextContainer}>
                ...
                <Text style={styles.gridValue}>{profile.partnerPref.location}</Text>
              </View>
            </View>
          </View>
        </View>
